...
import { MapPin, Trash, Heart, Medal, Settings, Home, Car } from "lucide-react"

const sidebarItems = [
  { href: "/", icon: Home, label: "Home" },
  { href: "/report", icon: MapPin, label: "Report Waste" },
  { href: "/collect", icon: Trash, label: "Collect Waste" },
  { href: "/rewards", icon: Heart, label: "Rewards" }, // Updated to Heart icon
          ...
          <Link href="/settings" passHref>
            <Button 
              ...
              className={`w-full py-3 ${
                pathname === "/settings"
                  ? "bg-[#006A4E] text-white" // Bottlegreen for active
                  : "text-gray-600 border-gray-300 hover:bg-gray-50 hover:text-gray-800" // Lighter hover effect
              }`} 
            >
